...
export default function Header() {
  ...
  return (
    <header className="bg-primary text-primary-foreground md:bg-gray-900 md:text-white overflow-hidden transition-colors duration-300 ease-in-out shadow-md md:shadow-none">
      <div className="container mx-auto px-4 py-3">
        {/* Logo i UserMenu */}
        ...
        {/* Nawigacja - wszystkie przyciski w jednym kontenerze */}
